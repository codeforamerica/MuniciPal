...
describe "event_items/new" do
  before(:each) do
    assign(:event_item, stub_model(EventItem,
      :event_id => 1,
      :EventItemId => 1,
  ...
  it "renders new event_item form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", event_items_path, "post" do
